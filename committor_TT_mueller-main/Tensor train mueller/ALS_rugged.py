...
class ALS_update:
    def __init__(self,beta,d,max_pol_deg,max_pol_deg_px,rank,rho,retrieve,filename = 'Q'):
        ...
        self.pab = orth_pol_px.orth_pab_rugged(beta,d,max_pol_deg,max_pol_deg_px)
        self.comp = contraction.Component_rugged(beta,d,max_pol_deg,max_pol_deg_px)
...
import time
Als = ALS_update(1/10,2,25,229,7,50,False)
Als.solve(20)
